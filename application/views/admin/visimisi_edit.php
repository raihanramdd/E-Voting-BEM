            ...
            <input type="hidden" name="id" value="<?php echo $row->id ?>"
                ...
                <div class="form-group">
                    ...
                    <select name="id_kandidat" id="id_kandidat" class="form-control">
                        <?php foreach ($kandidat as $knd) : ?>
                            <option value="<?php echo $knd->id ?>" <?php echo $row->id_kandidat ==
                            $knd->id ? 'selected' : ''?><?php echo $knd->nama_kandidat ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="visi" id="visi" class="form-control ckeditor" required>
                        <?php echo $row->visi ?></textarea>
                </div>

                <div class="form-group">
                    <label for="misi">Misi</label>
                    <textarea name="misi" id="misi" class="form-control ckeditor" required>
                        <?php echo $row->misi ?></textarea>
                </div>

                <a href="<?php echo site_url('admin/visi_misi'); ?>" class="btn bg-blue mb-3"><i class="fa fa-arrow-left"></i> Kembali</a>
